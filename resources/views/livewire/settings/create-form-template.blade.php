                ...
                <div class="flex cygwm cfrx6 chmlm">
                    ...
                    <div class="ckut6">
                        <div class="c3goj caod7">
                            <section>
                                <h3 class="text-slate-800 dark:text-slate-100 font-bold ctbo0 cvvcr ci4cg">New Form Template</h3>
                                <div class="cxbdy c95r9 cuga1 cxebx clk9r cggtb">
                                    <div class="czb6y">
                                        <label class="block text-sm cw92y ci4cg" for="name">Form Name</label>
                                        <input id="templateName" class="c03gb c3ff8" type="text" wire:model="templateName">
                                    </div>
                                    <div class="czb6y">
                                        <label class="block text-sm cw92y ci4cg" for="business-id">Display Name</label>
                                        <input id="templateDisplayName" class="c03gb c3ff8" type="text" wire:model="displayName">
                                    </div>
                                </div>
                            </section>
                        ...
                        <footer>
                            <div class="flex border-slate-200 dark:border-slate-700 chmlm c87xd cdsqp c7s20">
                                <div class="flex c93ao">
                                    ...
                                    <button class="btn ml-3 cfeqx cf1ce ceqwg" id="saveTemplate">Save Changes</button>
                                </div>
                            </div>
                        </footer>
...
@push('scripts')
    ...
    <script>
        jQuery($ => {
            const existingFormData = @json($this->templateData);
